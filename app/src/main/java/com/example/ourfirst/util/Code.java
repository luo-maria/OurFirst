...
public class Code {
    /**
     * 随机数数组
     * 去除了易混淆的 数字 0 和 字母 o O； 数字 1 和 字母 i I l L；数字 6 和 字母 b
     * 数字 9 和 字母 q； 字母 c C 和 G；字母 t （经常和随机线混在一起看不清）
     * >>>但是降低了安全性!
     */
    ...
    //设置单例模式——保证这个对象就一个，不会造成大量垃圾占用内存等等
    ...
    //default settings
    //验证码默认随机数的个数、字体大小、线条的条数、padding值、验证码的默认宽高
