...
public class Select_club extends AppCompatActivity {
    Spinner sp, sp1, sp2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level1=intent1.getStringExtra("level");
        campus1=intent1.getStringExtra("campus");
        kind1=intent1.getStringExtra("kind");
        System.out.println("这里是Select_club的username:"+username);
        DatabaseHelper dbtest = new DatabaseHelper(Select_club.this);
        final SQLiteDatabase db = dbtest.getWritableDatabase();

        // 为列表项设置监听器
        Map<String, Object> item;
        final List<Map<String, Object>> data = new ArrayList<Map<String, Object>>();
        Cursor cursor = db.rawQuery("select * from club where level=? and campus=? and kind=?",new String[]{level1,campus1,kind1});
        ...
        clubs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                intent = new Intent(Select_club.this, Club_detailActivity.class);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Select_club.this, Search_club.class);
                Intent intent1=getIntent();
                String username=intent1.getStringExtra("username");
                intent.putExtra("username",username);
        ...
        arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Select_club.this, Select_club.class);
                Intent intent1=getIntent();
                String username=intent1.getStringExtra("username");
                intent.putExtra("username",username);
