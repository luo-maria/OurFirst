...
import com.example.ourfirst.Activity.LoginActivity;
import com.example.ourfirst.Activity.RegisterActivity;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (System.currentTimeMillis() - exitTime > 2000) {
                Toast.makeText(MainActivity.this, getResources().getString(R.string.exit_hint), Toast.LENGTH_SHORT).show();
